...
The `onEvent` method will create a new Lambda [Function](./function/index.md) and attach it to the `Queue`. Your Function will be called with a `SQSEvent` containing the messages to be processed.
